...
const CouponListItem = () => {
    ...
    const { active, amount, available, date, img, points, title, url } = history.location.coupon.couponInfos;
        ...
        <div className='coupon-list-item__screen'>
            ...
            <div className="coupon-list-item__coupon">
                <CouponCard
                    ...
                    date={date}
                    points={points}
                    available={available} title={title} active={active} />
            </div>
...

            {
                (available && !active) && (
                    <>
                        ...
                        <p className='coupon-list-item__text'>Activer votre QR CODE et profiter des <br /> remises instantanées en magasin</p>
...

            {
                !available && (
                    <>
                        <h2 className='coupon-list-item__title not-available'>Oups !! vous n’avez pas assez de points</h2>
